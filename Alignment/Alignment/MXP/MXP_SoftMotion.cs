...
namespace Alignment
{
    public class MXP
    {
        ...
        extern public static int MXP_IsInited(ref Byte Status);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_InitKernel(ref UInt32 Status);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_Destroy();

        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_SystemRun();
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_SystemReset();
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_SystemStop();

        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_InitKernel_Developer(ref UInt32 Status);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_Destroy_Developer();

        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetKernelStatus(out Int32 Status);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetOnlineMode(ref UInt32 Status);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_IsSlaveOnline(UInt32 SlaveNo, out UInt32 Status);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetSlaveCount(UInt32 IsAxis, out UInt32 Count);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_QueryNodeType(UInt32 SlaveNo, out UInt32 NodeType);

        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetSlaveName(UInt32 SlaveNo, [MarshalAs(UnmanagedType.LPWStr)]StringBuilder pName);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetSystemInformation(out MXP_SYSINFO_OUT SysInfo);

        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetAxisNoFromNodeId(UInt32 NodeId, out UInt32 AxisNo);
        [DllImport("MXP_SoftMotion.dll")]
        extern public static int MXP_GetSlaveNoFromNodeId(UInt32 NodeId, out UInt32 SlaveNo);
