...
namespace Scan.MXP_MOTOR
{
    public class Motor
    {
        ...
        public void Align()
        {
            ...
            Po_Abs_In.Position = home_position;
        ...
        public void Rel_Fast_Move(int index)
        {
            ...
            Ne_Rel_In.Velocity = 80;
            Ne_Rel_In.Acceleration = (float)15;
            Ne_Rel_In.Deceleration = (float)15;
            Ne_Rel_In.Jerk = 10000;
            Ne_Rel_In.BufferMode = MXP.MXP_BUFFERMODE_ENUM.MXP_BUFFERED;
            Ne_Rel_In.Execute = 0;
            MXP.MXP_MoveRelativeCmd(110, ref Ne_Rel_In);
